...
bool Config::addScreen(const std::string &name)
{
  ...
  addOption(
      name, kOptionModifierMapForAlt,
      modifierIDValueFromString(Settings::value(Settings::Screen::ModifierAlt.arg(screen)).toString())
  );
  addOption(
      name, kOptionModifierMapForAltGr,
      modifierIDValueFromString(Settings::value(Settings::Screen::ModifierAltGr.arg(screen)).toString())
  );
  addOption(
      name, kOptionModifierMapForControl,
      modifierIDValueFromString(Settings::value(Settings::Screen::ModifierCtrl.arg(screen)).toString())
  );
  addOption(
      name, kOptionModifierMapForMeta,
      modifierIDValueFromString(Settings::value(Settings::Screen::ModifierMeta.arg(screen)).toString())
  );
  addOption(
      name, kOptionModifierMapForShift,
      modifierIDValueFromString(Settings::value(Settings::Screen::ModifierShift.arg(screen)).toString())
  );
  addOption(
      name, kOptionModifierMapForSuper,
      modifierIDValueFromString(Settings::value(Settings::Screen::ModifierSuper.arg(screen)).toString())
  );
